  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div
          className="rounded-t-2xl border border-b-0 border-border-strong bg-surface-1/95 px-3 pt-2.5 shadow-panel backdrop-blur-xl md:px-4"
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <svg className="h-4 w-4" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
                <path
                  d={isExpanded ? "M3.5 6 8 10.5 12.5 6" : "M3.5 10 8 5.5 12.5 10"}
                  strokeLinecap="round"
