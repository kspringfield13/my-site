      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,0.34fr)_minmax(0,0.66fr)]">
        ...
        <div className="space-y-12">
          <header className="space-y-4">
            ...
            <p className="max-w-3xl text-sm text-muted">
              Today I’m a Business Analyst at Cisco, supporting global sales enablement through analytics, data products, and insight pipelines. Alongside that role, I explore AI tools, data platforms, and build experimental projects that sit at the intersection of analytics, engineering, and creativity. Most projects here didn’t start as “portfolio work.” They started as curiosity, annoyance, or obsession. 
            </p>
            <p className="max-w-3xl text-sm text-muted">
