...
- The homepage `Now` section should show only the single most recent entry within `expireDays` for each category, ordered as Ventures, Tools, Ideas, and Models. Expired and superseded entries belong in the archive and must remain available there.
