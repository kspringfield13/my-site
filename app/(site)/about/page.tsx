        ...
        <div className="space-y-12">
          <header className="space-y-4">
            ...
            <p className="lede max-w-3xl">
              Welcome, I’m Kyle! A Business Intelligence Manager by title, a systems builder by instinct, and a lifelong tinkerer by habit.
            </p>
            ...
            <p className="max-w-3xl text-sm text-muted">
              Today I’m a Business Intelligence Manager at Cisco, partnering with sales operations leaders, program owners, and cross-functional stakeholders to turn complex business needs into governed datasets, executive-ready reporting, and actionable dashboards. I build Tableau dashboards and Django apps, maintain scalable dbt models in Snowflake, and combine Cursor with Claude Code to iterate faster across application development, analytics workflows, data validation, and recurring reporting logic. Alongside that role, I explore AI tools, data platforms, and experimental projects at the intersection of analytics, engineering, and creativity. Most projects here didn’t start as “portfolio work.” They started as curiosity, annoyance, or obsession.
            </p>
            <p className="max-w-3xl text-sm text-muted">
